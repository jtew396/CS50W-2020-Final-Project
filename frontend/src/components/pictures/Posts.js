...
class PostCard extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            is_liked: props.post.user_liked
        };
    }
    ...
    render() {
        ...
        console.log('This post is created by the user')
        console.log(isCreatedByUser)
        console.log(this.props.post.created_by_username)
        console.log(this.props.username)
        
        return (
            <Card className="shadow my-2">
                <Card.Body>
                    <Card.Title>{this.props.post.created_by_username}</Card.Title>
                    ...
                    <LikeButton logged_in={this.props.logged_in} is_liked={this.state.is_liked} handleLike={this.handleLike}/> <a>{this.props.post.likes}</a>
